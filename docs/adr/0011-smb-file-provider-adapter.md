...
server-name field reflection have been removed. SMBLibrary receives the original
logical server name directly, including for authentication and UNC paths. Clients
it creates for DFS referrals inherit that same network boundary. Non-isolated
