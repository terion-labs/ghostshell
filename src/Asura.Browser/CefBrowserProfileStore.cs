...
/// <summary>
/// Owns the CEF request contexts behind Asura browser profiles. Durable
        ...
        CancellationToken cancellationToken)
    {
        ...
        foreach (var entry in _contexts.Values.Where(entry => entry.IsDurable))
        {
                    ...
                    or InvalidOperationException)
            {
                ...
                var stage = exception.Data["Asura.BrowserSealStage"] switch
                {
                ...
                var sourceCategory = exception.Data["Asura.BrowserSealSourceCategory"] switch
                {
        ...
        Func<string?>? authenticationRouteSource = null)
    {
        ...
        lock (_gate)
        {
            ...
            var durableSelection = profile.Definition.Persistence
                == Asura.Core.BrowserProfilePersistence.DurableMetadata;
