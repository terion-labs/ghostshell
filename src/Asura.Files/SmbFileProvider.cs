...
public sealed class SmbFileProvider : RemoteHierarchicalFileProvider
{
            ...
            ProviderLimits)
    {
        ...
        diagnostics.Add(new SmbProviderDiagnostic(
            ...
            "SMBLibrary negotiates signing and SMB 3 encryption, but does not expose the selected dialect or encryption state; Asura cannot attest that this share encrypts file data."));
