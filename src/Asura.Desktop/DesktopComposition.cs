...
public static class DesktopComposition
{
    public static ServiceProvider CreateServiceProvider(DesktopProfileConfiguration? profile = null)
    {
        ...
        services.AddSingleton(provider => new ApplicationEncryptionRuntime(
            ...
            // in hand.
            () => provider.GetRequiredService<AsuraDatabase>()));
        ...
        services.AddSingleton<AsuraDatabase>();
        ...
        services.AddSingleton<Asura.Mcp.Server.WorkspaceMcpServer>();
        services.AddSingleton(provider => new Asura.Mcp.Server.LocalMcpServerControl(
            provider.GetRequiredService<Asura.Mcp.Server.WorkspaceMcpServer>(),
        ...
        services.AddSingleton<Asura.App.QuickTerminalController>();
        services.AddSingleton<Asura.App.App>();
