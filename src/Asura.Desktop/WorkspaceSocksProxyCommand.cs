...
{
    private const string Switch = "--asura-workspace-socks-connect";
        ...
        CancellationToken cancellationToken)
    {
        ...
        var credentials = new Asura.Application.WorkspaceNetworkProxyCredentials(
        ...
        var upload = StartCopyThread(
            ...
            stream,
            uploadFinished,
            "Asura SSH proxy upload");
        var download = StartCopyThread(
            stream,
            standardOutput,
            downloadFinished,
            "Asura SSH proxy download");
