...
namespace Microsoft.Data
{
    internal partial class StringsHelper : Strings
    {
        internal class ResourceNames
        {
            ...
            internal const string DataCategory_ConnectionResiliency = @"Connection Resiliency";
            ...
            internal const string Xml_TooManyIsDataSetAttributeInSchema = @"Cannot determine the DataSet Element. IsDataSet attribute exist more than once.";
            ...
            internal const string Expr_DatatypeConversion = @"Cannot convert from {0} to {1}.";
            internal const string Expr_DatavalueConversion = @"Cannot convert value '{0}' to Type: {1}.";
            ...
            internal const string Expr_FilterConversion = @"Filter expression '{0}' does not evaluate to a Boolean term.";
            ...
            internal const string DataColumn_OrdinalExceedMaximum = @"Ordinal '{0}' exceeds the maximum number.";
            ...
            internal const string DataMerge_RelationKeyColumnsMismatch = @"Relation {0} cannot be merged, because keys have mismatch columns.";
            ...
            internal const string NamedSimpleType_InvalidDuplicateNamedSimpleTypeDeclaration = @"Simple type '{0}' has already be declared with different '{1}'.";
            ...
            internal const string StrongTyping_CannotRemoveRelation = @"Cannot remove relation since it is built in to this dataSet.";
            ...
            internal const string StrongTyping_CannotAccessDBNull = @"Cannot get value because it is DBNull.";
            ...
            internal const string ADP_ConnectionRequired_UpdateRows = @"Update requires a connection.";
	...
	The value was a valid value for the property and the provider supports the property as a settable property, but the provider does not support the value specified. This includes the case where the value was added to the property in OLE DB after the provider was written.";
            ...
            internal const string SQL_ContextConnectionIsUnsupported = @"Connecting to the context connection using Microsoft.Data.SqlClient is not supported.";
            ...
            internal const string SqlUdtReason_NativeFormatExplicitLayoutNotAllowed = @"The type of field '{0}' is marked as explicit layout which is not allowed in Native format";
            ...
            internal const string SNI_ERROR_10 = @"Socket is null";
            ...
            internal const string SQLROR_RecursiveRoutingNotSupported = @"Too many redirections have occurred. Only {0} redirections per login is allowed.";
            ...
            internal const string SQLCR_TDSVersionNotPreserved = @"The server did not preserve the exact client TDS version requested during a recovery attempt, connection recovery is not possible.";
            ...
            internal const string AttestationTokenSignatureValidationFailed = @"The validation of an attestation token failed. The token signature does not match the computed signature using a public key retrieved from the attestation public key endpoint at '{0}'. Verify the DNS mapping for the endpoint - see https://go.microsoft.com/fwlink/?linkid=2157649 for more details. If correct, contact Customer Support Services.";
            ...
            internal const string ADP_InvalidMixedUsageOfAccessTokenAndTokenCallback = @"Cannot set the AccessToken property if the AccessTokenCallback has been set.";
            internal const string ADP_InvalidMixedUsageOfAccessTokenCallbackAndIntegratedSecurity = @"Cannot set the AccessTokenCallback property if the 'Integrated Security' connection string keyword has been set to 'true' or 'SSPI'.";
            internal const string ADP_InvalidMixedUsageOfAuthenticationAndTokenCallback = @"Cannot set the AccessTokenCallback property if 'Authentication=Active Directory Default' has been specified in the connection string.";
            internal const string event_OperationReturnedSomething = @"{0} returned {1}.";
            internal const string net_auth_message_not_encrypted = @"Protocol error: A received message contains a valid signature but it was not encrypted as required by the effective Protection Level.";
            internal const string net_log_operation_failed_with_error = @"{0} failed with error {1}.";
            internal const string net_MethodNotImplementedException = @"This method is not implemented by this class.";
            internal const string net_securitypackagesupport = @"The requested security package is not supported.";
            internal const string SNI_IncorrectPhysicalConnectionType = @"Incorrect physicalConnection type.";
            internal const string SqlAppContextSwitchManager_InvalidValue = @"Exception occurred while trying to set the AppContext Switch '{0}'={1}.";
            internal const string SQL_DbTypeNotSupportedOnThisPlatform = @"Type {0} is not supported on this platform.";
            internal const string SQL_GlobalizationInvariantModeNotSupported = @"Globalization Invariant Mode is not supported.";
            internal const string SQL_KerberosTicketMissingError = @"Cannot authenticate using Kerberos. Ensure Kerberos has been initialized on the client with 'kinit' and a Service Principal Name has been registered for the SQL Server to allow Kerberos authentication.";
            internal const string SQL_NetworkLibraryNotSupported = @"The keyword 'Network Library' is not supported on this platform, prefix the 'Data Source' with the protocol desired instead ('tcp:' for a TCP connection, or 'np:' for a Named Pipe connection).";
            internal const string SQL_SocketDidNotThrow = @"Socket did not throw expected '{0}' with error code '{1}'.";
            internal const string SQL_UnsupportedFeature = @"The server is attempting to use a feature that is not supported on this platform.";
            internal const string SQL_UnsupportedKeyword = @"The keyword '{0}' is not supported on this platform.";
            internal const string SQL_UnsupportedSysTxVersion = @"The currently loaded System.Transactions.dll does not support Global Transactions.";
            internal const string SQL_UnsupportedToken = @"Received an unsupported token '{0}' while reading data from the server.";
            internal const string SSPIInvalidHandleType = @"'{0}' is not a supported handle type.";
            internal const string SqlFileStream_NotSupported = @"SqlFileStream is not supported on this platform.";
            internal const string LocalDBNotSupported = @"LocalDB is not supported on this platform.";
            internal const string net_context_buffer_too_small = @"Insufficient buffer space. Required: {0} Actual: {1}.";
            internal const string net_gssapi_operation_failed = @"GSSAPI operation failed with status: {0} (Minor status: {1}).";
            internal const string net_gssapi_operation_failed_detailed = @"GSSAPI operation failed with error - {0} ({1}).";
            internal const string net_nego_channel_binding_not_supported = @"No support for channel binding on operating systems other than Windows.";
            internal const string net_nego_not_supported_empty_target_with_defaultcreds = @"Target name should be non empty if default credentials are passed.";
            internal const string net_nego_protection_level_not_supported = @"Requested protection level is not supported with the GSSAPI implementation currently installed.";
            internal const string net_nego_server_not_supported = @"Server implementation is not supported.";
            internal const string net_ntlm_not_possible_default_cred = @"NTLM authentication is not possible with default credentials on this platform.";
            ...
            internal const string SQL_RemoteCertificateChainErrors = @"Certificate failed chain validation. Error(s): '{0}'.";
            internal const string SQL_RemoteCertificateNameMismatch = @"Certificate name mismatch. The provided 'DataSource' or 'HostNameInCertificate' does not match the name in the certificate.";
            internal const string SQL_RemoteCertificateNotAvailable = @"Certificate not available while validating the certificate.";
            internal const string SQL_RemoteCertificateDoesNotMatchServerCertificate = @"The certificate provided by the server does not match the certificate provided by the ServerCertificate option.";
            internal const string SQL_JsonDocumentNotSupportedOnColumnType = @"Invalid attempt to get JsonDocument on column '{0}'. JsonDocument is only supported for columns of type json.";
        }
    }
}
