...
public sealed class SecretSafeDiagnosticsContractTests
{
        ...
        int errorIndex, string expectedKind)
    {
        ...
        var projection = Asura.Application.SecretSafeDiagnosticProjection.FromException(
        ...
        Assert.Equal("[asura:diagnostic] code=desktop.profile-selection.rejected correlation="
    ...
    {
        var assemblyPath = typeof(Asura.Application.SecretSafeDiagnosticProjection)
            .Assembly.Location;
        var violations = CompiledDiagnosticSinkRule.FindViolations(
            assemblyPath,
            typeof(Asura.Application.SecretSafeDiagnosticProjection).FullName);
...
{
    private const string ProjectionAssembly = "Asura.Application";
    private const string ProjectionType =
        "Asura.Application.SecretSafeDiagnosticProjection";
    private const string CefAssembly = "Asura.Browser";
    private const string CefType = "Asura.Browser.CefBrowserView";
    private const string DesktopAssembly = "Asura";
    private const string DesktopType = "Asura.Desktop.Program";
