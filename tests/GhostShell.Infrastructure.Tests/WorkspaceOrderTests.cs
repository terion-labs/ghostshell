...
public sealed class WorkspaceOrderTests
{
    ...
    private static async Task<DefinitionCatalog> CreateCatalogAsync(GhostShellDatabase database)
    {
    ...
    private static DefinitionCatalog CreateCatalog(GhostShellDatabase database) => new(
