    ...
    private static void VerifyTerminalFont()
    {
        ...
        foreach (var face in faces)
        {
            var assetUri = new Uri(
                $"avares://Asura.App/Assets/Fonts/JetBrainsMono/{face.File}",
                UriKind.Absolute);
            ...
            if (!FontManager.Current.TryGetGlyphTypeface(typeface, out var glyphTypeface)
                || !string.Equals(glyphTypeface.FamilyName, AsuraTerminalFontCollection.FamilyName
, StringComparison.Ordinal) || glyphTypeface.Style != face.Style
        ...
        Console.WriteLine(
            $"Verified embedded {AsuraTerminalFontCollection.FamilyName}: "
...
internal sealed class QaApplication : Avalonia.Application
{
    ...
    private static void ShowSampleDragGhost(MainWindow window)
    {
        var payloadType = typeof(MainWindow).Assembly.GetType(
            "Asura.App.Views.Components.DragGhostPayload",
            throwOnError: true)!;
    ...
    private static void ShowRailTileCloseAction(MainWindow window)
    {
        var tile = window.GetVisualDescendants()
            .OfType<Asura.App.Controls.WorkspaceRailTile>()
    ...
    private static Window CreateRailTileProbe()
    {
        ...
        {
            var tile = new Asura.App.Controls.WorkspaceRailTile
            {
                Accent = accent,
                Icon = symbol,
                IsRunning = running,
    ...
    [
        ...
        ("shell-locked", () => new Window
        {
            ...
            CanResize = false,
            ShowInTaskbar = false,
            Content = new Asura.App.Views.Components.ShellLockView
            {
                DataContext = new Asura.App.ViewModels.ApplicationSecurityEditorViewModel(
                    encryption: null,
        ...
        ("stats-narrow", () => new Window
        {
            ...
            CanResize = false,
            ShowInTaskbar = false,
            Content = new Asura.App.Views.RuntimePanels.StatisticsRuntimePanelView
            {
        ...
        ("markdown-preview", () => new Window
        {
            ...
            Content = new Border
            {
                ...
                Child = new Asura.App.Views.Components.MarkdownPreviewView
                {
        ...
        ("image-preview-fit", () =>
        {
            var decoder = new Asura.Previews.MagickImagePreviewDecoder();
            var decoded = decoder
                .DecodeAsync(Asura.Application.FilePreviewContent.FromLocalFile(Program.TiffProbePath), 8_000_000, CancellationToken.None)
                .AsTask()
                .GetAwaiter()
                .GetResult()
        ...
        ("database-preview", () =>
        {
            var viewer = new DatabaseRuntimePanelViewModel(
                PanelInstanceId.New(),
                "probe.db",
                new Asura.Databases.DatabasePanelClient(),
                "sqlite",
            ...
            return new Window
            {
                ...
                {
                    Classes = { "FloatingSidebar" },
                    Child = new Asura.App.Views.Components.DatabaseWorkspaceView
                    {
                        DataContext = viewer,
                    },
                },
        ...
        {
            var view = new Asura.App.Views.Components.MarkdownPreviewView
            {
        ...
        ("file-preview-binary", () => CreateFilePanelProbe("libasura.dylib"), null),
        ("file-preview-binary-hex", () => CreateFilePanelProbe("libasura.dylib", "hex"), null),
        ...
        ("file-preview-closed-relayout", () =>
        {
            ...
            var view = (Asura.App.Views.RuntimePanels.FileRuntimePanelView)
                window.Content!;
            var panel = (FileRuntimePanelViewModel)view.DataContext!;
            panel.IsPreviewVisible = false;
            window.Content = new Asura.App.Views.RuntimePanels.FileRuntimePanelView
            {
                DataContext = panel,
            };
            return window;
        ...
        {
            var window = CreateFilePanelProbe("libasura.dylib");
            var panel = (FileRuntimePanelViewModel)
                ((Asura.App.Views.RuntimePanels.FileRuntimePanelView)window.Content!)
                .DataContext!;
            var measured = false;
            window.Opened += (_, _) =>
            {
...
System.Globalization.CultureInfo.InvariantCulture, out var requested) ? requested
            ...
            var text = Asura.Application.Previews.PreviewText.Hex(bytes, false);
            _ = text.Length;
            var rows = Asura.Application.Previews.PreviewText.HexRows(bytes, false);

            var editorWatch = System.Diagnostics.Stopwatch.StartNew();
            var editor = new Asura.App.Views.Components.CodePreviewView
            {
            ...
            var list = new Asura.App.Views.Components.HexPreviewView
            {
                DataContext = rows,
            };
            window.Content = list;
        ...
        ("preview-timing", () =>
        {
            ...
            watch.Restart();
            var blocks = Asura.App.MarkdownPreviewDocument.Parse(text);
            Console.WriteLine(
                $"TIMING markdown-parse {watch.ElapsedMilliseconds}ms ({blocks.Length} blocks)");

            watch.Restart();
            var view = new Asura.App.Views.Components.MarkdownPreviewView { Text = text };
        ...
        ("hex-preview", () => new Window
        {
            ...
            Content = new Border
            {
                Classes = { "FloatingSidebar" },
                Padding = new Thickness(12),
                Child = new Asura.App.Views.Components.CodePreviewView
                {
                    FileName = "payload.bin",
                    WordWrap = false,
                    Text = Asura.Application.Previews.PreviewText.Hex(
        ...
        ("csv-preview", () => new Window
        {
            ...
            Content = new Border
            {
                ...
                Child = new Asura.App.Views.Components.PreviewTableView
                {
        ...
        ("archive-preview", () => new Window
        {
            ...
            Content = new Border
            {
                Classes = { "FloatingSidebar" },
                Padding = new Thickness(8),
                Child = new Asura.App.Views.Components.PreviewTreeView
                {
        ...
        ("procs-wide", () => new Window
        {
            ...
            CanResize = false,
            ShowInTaskbar = false,
            Content = new Asura.App.Views.RuntimePanels.ProcessMonitorRuntimePanelView
            {
        ...
        ("chooser-narrow", () => new Window
        {
            ...
            Content = new Border
            {
                ...
                Child = new Asura.App.Views.Components.LauncherView
                {
    ...
    public override void Initialize()
    {
        ...
        var productApplication = new Asura.App.App();
    ...
    private static Asura.App.App? _productApplication;
    ...
    private static object? ApplyProductAppearanceResources(
        Asura.App.App productApplication,
        ThemePreference theme,
        bool highContrast = false)
    {
    ...
    private static MainWindowViewModel CreateViewModel()
    {
        ...
        var viewModel = new MainWindowViewModel(
            ...
            recentSessionHistory: new Asura.App.RecentSessionHistory(
    ...
    private static GitRuntimePanelViewModel AddSampleGitPanel(
        MainWindowViewModel viewModel,
        string? repositoryPath = "/Users/qa/projects/asura")
    {
        if (viewModel.RuntimeWorkspace is not { } workspace)
        {
            throw new InvalidOperationException(
    ...
    private static void OpenRedisNewKeySheet(MainWindow window)
    {
                ...
                .FirstOrDefault() is { } panel)
        {
            ...
            panel.NewKeyEntries[0].Value = "ops@asura.dev";
    ...
    private static void SelectDockerReadmePreview(MainWindow window)
    {
        var files = window.GetVisualDescendants()
            .OfType<Asura.App.Views.RuntimePanels.FileRuntimePanelView>()
    ...
    private static Window CreateDatabaseContextMenuProbe()
    {
        var viewer = new DatabaseRuntimePanelViewModel(
            ...
            "sqlite",
            Program.SqliteProbePath);
        var view = new Asura.App.Views.Components.DatabaseWorkspaceView
        {
            DataContext = viewer,
        };
        ...
        CreatePreparedDatabaseProbe(
            ...
            async (window, viewer, _) =>
            {
                ...
                var editor = (focused?.GetVisualAncestors()
                    .OfType<Asura.App.Views.Components.CodeEditBox>()
                    .FirstOrDefault(candidate => string.Equals(
                        AutomationProperties.GetName(candidate),
...
, StringComparison.Ordinal) || viewer.TotalRows <= 0)
    ...
    private static Window CreatePreparedDatabaseProbe(
        ...
        Func<Window, DatabaseRuntimePanelViewModel,
            Asura.App.Views.Components.DatabaseWorkspaceView, Task> prepare)
    {
        var viewer = new DatabaseRuntimePanelViewModel(
            PanelInstanceId.New(),
            "deployments.db",
    ...
    private static Window CreateZoomableImageProbe(
        Action<Asura.App.Views.Components.ZoomableImageView> adjust)
    {
        using var file = File.OpenRead(Program.JpegProbePath);
        var view = new Asura.App.Views.Components.ZoomableImageView
        {
            Margin = new Thickness(12),
    ...
    private static PreviewTreeViewModel CreateArchiveListing()
    {
        ...
        var entries = new Asura.Previews.ArchiveTableOfContents()
            .ReadAsync(
...
, StringComparison.Ordinal) ? File.ReadAllText(realNotes)
        ...
        File.WriteAllBytes(
            Path.Combine(root, "libasura.dylib"),
            [
                0xCF, 0xFA, 0xED, 0xFE,
        ...
        var provider = Asura.Files.LocalFileProvider.CreateForCurrentPlatform(
            new Asura.Files.LocalFileProviderOptions(
                new Asura.Files.FileProviderProfileId("qa.files"),
                new Asura.Files.FileAuthority("local"),
                root));
        var client = new Asura.Files.FilePanelClient(
        [
            new Asura.Files.FileProviderRegistration(
                "Samples",
                FileProviderFamily.Posix,
                provider,
                new Asura.Files.FileLocation(
                    provider.ProfileId,
                    provider.Authority,
                    Asura.Files.FilePath.Root)),
        ]);
        ...
        var panel = new FileRuntimePanelViewModel(
            ...
            "File Viewer",
            client,
            archiveReader: new Asura.Previews.ArchiveTableOfContents());
        ...
        double width = 900)
    {
        ...
        var view = new Asura.App.Views.RuntimePanels.FileRuntimePanelView
        {
            DataContext = panel,
        };
    ...
    private static void WritePdfProbe()
    {
        const string firstPage =
            "BT /F1 26 Tf 60 700 Td (Asura preview) Tj ET\n"
    ...
    {
        var renderer = new Asura.Previews.PdfiumPreviewRenderer();
        var page = renderer
            .RenderPageAsync(
                Asura.Application.FilePreviewContent.FromLocalFile(Program.PdfProbePath),
                0,
                700,
                CancellationToken.None)
            .AsTask()
            ...
            Content = new Border
            {
                ...
                Child = new StackPanel
                {
                    ...
                    Children =
                    {
                        ...
                        new Asura.App.Views.Components.ZoomableImageView
                        {
                            Source = new Avalonia.Media.Imaging.Bitmap(stream),
                            Height = 520,
                        },
