...
internal static class QaData
{
    ...
    public static StoredDefinition<ApplicationNetworkSettings> ApplicationNetworkSettings { get; } =
        Stored(new ApplicationNetworkSettings(
            Asura.Core.ApplicationNetworkSettings.DefaultId,
            Asura.Core.ApplicationNetworkSettings.CurrentSchemaVersion,
...
internal sealed class QaLockedProtection : Asura.Application.IStartupProtection
{
...
internal sealed class QaBiometrics : Asura.Application.IBiometricAuthenticator
{
