...
test_dir="$(mktemp -d "${TMPDIR:-/tmp}/ghostshell-popup-probe.XXXXXX")"
...
xcrun clang -std=c11 -Wall -Wextra -Werror \
    ...
    native/browser-profile-tests/hosted_popups.c \
...
"${app}/Contents/MacOS/SessionCookies" "${test_dir}/state" \
    "${app}/Contents/Frameworks/GhostSHELL Helper.app/Contents/MacOS/GhostSHELL Helper"
